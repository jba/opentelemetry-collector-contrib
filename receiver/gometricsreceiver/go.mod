module github.com/open-telemetry/opentelemetry-collector-contrib/receiver/gometricsreceiver
...
require (
	...
	jba/work v0.0.0-00010101000000-000000000000 // indirect
)

replace jba/work => ../../../../../work
